...
public class CustomerAddress
{
    ...
    public boolean isShipFromAddress()
    {
        return shipFromAddress;
    }

    public void setShipFromAddress(boolean shipFromAddress)
    {
        this.shipFromAddress = shipFromAddress;
    }

    public boolean isServiceToAddress()
    {
        return serviceToAddress;
    }

    public void setServiceToAddress(boolean serviceToAddress)
    {
        this.serviceToAddress = serviceToAddress;
    }

    public boolean isInstallToAddress()
    {
        return installToAddress;
    }

    public void setInstallToAddress(boolean installToAddress)
    {
